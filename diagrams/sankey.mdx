...
description: Visualize flow and distribution between nodes with Sankey diagrams in Mermaid.
---
...
The CSV format follows [RFC 4180](https://www.ietf.org/rfc/rfc4180.txt) with two differences:
...
<Accordion title="Link colors">

Customize link colors with the `linkColor` option:
...
- Hex code - Specific color like `#a1a1a1`
...
<Accordion title="Node alignment">
